			   ...
			   <div class="col-lg-6 col-md-6 col-sm-12">
				  <div class="pricing_div">
					...
					<div class="pack-list">
		                ...
		                <p><?php echo get_languageword('Discount')?>:<span><?php echo get_system_settings('currency_symbol').' '. $l->discount;?></span></p>
						<?php }
						else
						{?>
		                <p> <?php echo get_languageword('Discount');?>:<span><?php echo  $l->discount;?> %</span></p>
						<?php }
						?>
					 ...
					 <div class="radio">
						<label>
							<input type="radio" name="package_id" value="<?php echo $l->id?>" onclick="javascript:assign_price('<?php echo $l->id;?>', '<?php echo $final_cost * 100;?>', '<?php echo $l->package_name?>');">
